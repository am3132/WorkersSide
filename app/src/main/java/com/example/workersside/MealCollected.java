...
public class MealCollected extends AppCompatActivity {

    FirebaseFirestore db;
    RecyclerView mRecyclerView;
    ArrayList<Meal> mealArrayList;
    CollectedRecyclerViewAdapter adapter;
    Button updateButton;
    ...
    protected void onCreate(Bundle SavedInstanceState) {
        ...
        setContentView(R.layout.activity_meal_collected);
        setUpRecyclerView();
        setUpFireBase();
    ...
    private void setUpUpdateButton() {
        updateButton = findViewById(R.id.mUpdateButton2);
        ...
        db.collection("Collected")
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(MealCollected.this,"Problem --1--",Toast.LENGTH_LONG).show();
